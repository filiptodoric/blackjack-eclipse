...
//    driver.findElement(By.xpath("//button[@onclick='stand(player2_stand, 2, player3_hand)']")).click();
//    driver.findElement(By.cssSelector("#player3 > #button1")).click();
//    driver.findElement(By.xpath("//button[@onclick='stand(player3_stand, 3, player3_hand)']")).click();
//  }
//
//  @After
